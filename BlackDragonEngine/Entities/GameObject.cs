...
namespace BlackDragonEngine.Entities
{
    ...
    public class GameObject : IGameObject
    {
        ...
        {
            get => new Rectangle((int) Position.X + collisionRectangle.X, (int) Position.Y + collisionRectangle.Y,
        ...
        {
            get => new BCircle(Position + collisionCircle.Position, collisionCircle.Radius);
            set => collisionCircle = value;
        }

        public Vector2 BCircleLocalCenter => collisionCircle.Position;

        /// <summary>
        ///     Gets the collision center of the object in world coordinates
        /// </summary>
        public Vector2 RectCollisionCenter => new Vector2((CollisionRectangle.Right + CollisionRectangle.Left) / 2,
            (CollisionRectangle.Bottom + CollisionRectangle.Top) / 2);

        /// <summary>
        ///     Gets the collision center of the object in world coordinates
        /// </summary>
        public Vector2 CircleCollisionCenter => Position + collisionCircle.Position;

        /// <summary>
        ///     Position of the object in screencoordinates (used when drawing)
        /// </summary>
        public Vector2 ScreenPosition => ShortCuts.Vector2Point(Camera.WorldToScreen(Position));
        ...
        {
            foreach (var component in components) component.Receive(message, obj);
        }
